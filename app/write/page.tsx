...
export default function WritePage() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.success(
                'Your letter has been submitted! Thank you for sharing your story.'
            );
    ...
    return (
        <div className='min-h-screen bg-background stationery-paper'>
            ...
            <nav className='flex justify-between items-center p-6 max-w-6xl mx-auto'>
                ...
                <h1 className='text-2xl serif-title text-primary font-semibold'>
                    Dear Failure
                </h1>
                <Link
                    href='/letters'
            ...
            <main className='max-w-3xl mx-auto px-6 py-8'>
                <div className='text-center mb-12'>
                    ...
                    <p className='text-lg text-muted-foreground max-w-2xl mx-auto'>
                        Share your story of growth, resilience, and
                        transformation. Your words may inspire someone else on
                        their journey.
                    </p>
                </div>
                ...
                <div className='mt-16 text-center'>
                    <div className='bg-accent/30 rounded-xl p-8'>
                        ...
                        <p className='text-muted-foreground max-w-2xl mx-auto'>
                            Think about a moment when you felt like you failed,
                            but looking back, it taught you something valuable.
                            What would you say to that version of yourself?
                        </p>
                    </div>
                </div>
            </main>
